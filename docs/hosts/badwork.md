...
```text
Arch     : x86_64
CPU      : 12 x AMD Ryzen 5 PRO 4650U with Radeon Graphics
BogoMIPS : 4193
RAM      : 32 Go Go
DISK     : 953.87 GiB Go
KERNEL   : 5.19.13
...
![hardware topology](https://raw.githubusercontent.com/badele/nix-homelab/master/docs/hosts/badwork/topologie.svg)
