...
```
System:
  Kernel: 5.15.74 aarch64 bits: 64 compiler: gcc v: 9.5.0 Console: N/A Distro: NixOS 23.05 (Stoat) 
Machine:
  Type: ARM Device System: Raspberry Pi 4 Model B Rev 1.4 details: BCM2835 rev: d03114 
  serial: <filter> 
Memory:
  RAM: total: 7.62 GiB used: 5.01 GiB (65.8%) 
...
Network:
  ...
  WAN IP: <filter> 
RAID:
  Device-1: zroot type: zfs status: ONLINE level: linear size: 464 GiB free: 456 GiB 
  allocated: 7.85 GiB 
  Components: Online: N/A 
Drives:
  Local Storage: total: raw: 495.48 GiB usable: 959.48 GiB used: 5.28 GiB (0.6%) 
  ID-1: /dev/mmcblk0 vendor: SanDisk model: SL32G size: 29.72 GiB rotation: SSD serial: <filter> 
  scheme: MBR 
  ID-2: /dev/sda type: USB vendor: Hitachi model: HTS547550A9E384 size: 465.76 GiB 
  rotation: 5400 rpm serial: <filter> rev: JE3O scheme: GPT 
Partition:
  ID-1: / size: 441.82 GiB used: 47.8 MiB (0.0%) fs: zfs logical: zroot/private/root 
...
Sensors:
  ...
  Fan Speeds (RPM): N/A 
Info:
  Processes: 203 Uptime: 14:21:04  up 7 days  3:19,  0 users,  load average: 0.25, 0.09, 0.02 
