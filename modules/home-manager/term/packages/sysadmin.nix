...
in
{
  ...
  home.packages = with pkgs; [
    ...
    eza # ls alternative with more features and better UI
    fd # find alternative with better UI and more features
    ripgrep # grep alternative with better UI and more features
    unzip # Unzip utility
