  ...
  programs = {
    zsh = {
      ...
      sessionVariables = {
        ...
        # Guard terminal capability lookups for non-interactive shells without TERM.
        LESS_TERMCAP_mb = "$([ -n \"$TERM\" ] && tput bold && tput setaf 2)"; # green
        LESS_TERMCAP_md = "$([ -n \"$TERM\" ] && tput bold && tput setaf 6)"; # cyan
        LESS_TERMCAP_me = "$([ -n \"$TERM\" ] && tput sgr0)";
        LESS_TERMCAP_so = "$([ -n \"$TERM\" ] && tput bold && tput setaf 3 && tput setab 4)"; # yellow on blue
        LESS_TERMCAP_se = "$([ -n \"$TERM\" ] && tput rmso && tput sgr0)";
        LESS_TERMCAP_us = "$([ -n \"$TERM\" ] && tput smul && tput bold && tput setaf 4)"; # purple
        LESS_TERMCAP_ue = "$([ -n \"$TERM\" ] && tput rmul && tput sgr0)";
        LESS_TERMCAP_mr = "$([ -n \"$TERM\" ] && tput rev)";
        LESS_TERMCAP_mh = "$([ -n \"$TERM\" ] && tput dim)";
        LESS_TERMCAP_ZN = "$([ -n \"$TERM\" ] && tput ssubm)";
        LESS_TERMCAP_ZV = "$([ -n \"$TERM\" ] && tput rsubm)";
        LESS_TERMCAP_ZO = "$([ -n \"$TERM\" ] && tput ssupm)";
        LESS_TERMCAP_ZW = "$([ -n \"$TERM\" ] && tput rsupm)";
