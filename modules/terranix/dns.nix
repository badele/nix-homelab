...
let
  ttl = 300;
  fqdn = "jesuislibre.org";
in
{
  resource.hetznerdns_zone.adele_im = {
    name = fqdn;
    ttl = 3600;
  };

  output.adele_im_zone_id = {
    value = config.resource.hetznerdns_zone.adele_im "id";
  };
  ...
  #       name = record.name;
  #       value = {
  #         zone_id = config.resource.hetznerdns_zone.adele_im "id";
