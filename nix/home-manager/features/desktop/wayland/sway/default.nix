    ...
    config = {
      ...
      keybindings =
        ...
        in
        {
          ...
          "${mod}+Shift+ampersand" = "move container to ${w} 1";
          "${mod}+Shift+eacute" = "move container to ${w} 2";
          "${mod}+Shift+quotedbl" = "move container to ${w} 3";
          "${mod}+Shift+apostrophe" = "move container to ${w} 4";
          "${mod}+Shift+parenleft" = "move container to ${w} 5";
          "${mod}+Shift+minus" = "move container to ${w} 6";
          "${mod}+Shift+egrave" = "move container to ${w} 7";
          "${mod}+Shift+underscore" = "move container to ${w} 8";
          "${mod}+Shift+ccedilla" = "move container to ${w} 9";
          "${mod}+Shift+agrave" = "move container to ${w} 0";
