...
This schema defines a GPT-based single-disk layout with a direct [btrfs-subvolume](https://www.man7.org/linux//man-pages/man8/btrfs-subvolume.8.html) root filesystem for organized data management.
